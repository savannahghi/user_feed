...
class _$GetFeedDataTearOff {
  ...
  _GetFeedData call({@JsonKey(name: 'getFeed') required Feed data}) {
    return _GetFeedData(
      data: data,
    );
  }
...
mixin _$GetFeedData {
  ...
  Feed get data => throw _privateConstructorUsedError;
...
abstract class $GetFeedDataCopyWith<$Res> {
  ...
  $Res call({@JsonKey(name: 'getFeed') Feed data});

  $FeedCopyWith<$Res> get data;
}
...
class _$GetFeedDataCopyWithImpl<$Res> implements $GetFeedDataCopyWith<$Res> {
  ...
  @override
  $FeedCopyWith<$Res> get data {
    return $FeedCopyWith<$Res>(_value.data, (value) {
      return _then(_value.copyWith(data: value));
    });
  }
}
...
class _$_GetFeedData implements _GetFeedData {
  _$_GetFeedData({@JsonKey(name: 'getFeed') required this.data});
...
abstract class _GetFeedData implements GetFeedData {
  factory _GetFeedData({@JsonKey(name: 'getFeed') required Feed data}) =
      _$_GetFeedData;
